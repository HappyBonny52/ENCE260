...
game.o: game.c ../../drivers/avr/system.h pacer.h display_main.h player.h
	$(CC) -c $(CFLAGS) $< -o $@
...
game.out: game.o system.o pio.o pacer.o player.o display_main.o navswitch.o controls.o bullet.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
